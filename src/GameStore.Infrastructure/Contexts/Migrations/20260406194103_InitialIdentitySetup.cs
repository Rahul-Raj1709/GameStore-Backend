        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LikedGamesId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameUser", x => new { x.LikedByUsersId, x.LikedGamesId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GameUser_Users_LikedByUsersId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "1a872d06-fb1f-4d0a-a4ed-65d9e7c9d90b", "SuperAdmin", "SUPERADMIN" },
                    { "2", "a2a19c3f-b0b8-47e5-ac58-9f8ef1f4a527", "Admin", "ADMIN" },
                    { "3", "1578f9b5-d938-4f02-9371-edad077e92cc", "Customer", "CUSTOMER" }
                });
